...
class Game {
    ...
    updateCarPosition() {
        this.carPosition = Math.abs(this.position) * this.carSpeedFactor;
...
// ========== GAME SCRIPT ==========
// [KODE GAME.JS TIDAK BERUBAH - tetap sama seperti sebelumnya]
// Hanya tambahkan ini di bagian paling bawah:
